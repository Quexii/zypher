...
public enum TranslateText {
	...
	UI_BLUR("text.ui.blur"), BLUR_STRENGTH("text.blur.strength"), MC_FONT("text.hud.mcfont"), CHANGELOG("text.changelog"), NEWS("text.news"), SEARCH("text.search"), SUPERHEROFX_NAME("text.superherofx.name"), SUPERHEROFX_DESCRIPTION("text.superherofx.description"), NO_INVIS_COLOR("text.noinvis.color"), NO_INVIS_NAME("text.noinvis.name"), NO_INVIS_DESCRIPTION("text.noinvis.description"), ESP_NAME("text.esp.name"), ESP_DESCRIPTION("text.esp.description");
